// @TODO: YOUR CODE HERE!
console.log("Error If Not Showing")
let svgWidth = 960
let svgHeight = 500
...
let renderXAxis = (newXScale, xAxis) => {
...
let renderYAxis = (newYScale, yAxis) => {
     let leftAxis = d3.axisLeft(newYScale)

     yAxis.transition().duration(2500).call(leftAxis)
     return yAxis
};
